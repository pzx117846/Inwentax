        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    serial_number = table.Column<string>(type: "TEXT", maxLength: 70, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    date_from = table.Column<DateTime>(type: "TEXT", nullable: false),
                    date_to = table.Column<DateTime>(type: "TEXT", nullable: true),
                    is_used = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Assignments_Phone_PhoneId",
                        column: x => x.PhoneId,

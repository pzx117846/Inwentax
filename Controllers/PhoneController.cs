...
namespace Inwentax.Controllers
{
    ...
    public class PhoneController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Brand,Model,Year,Imei,Status")] Phone phone)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Brand,Model,Year,Imei,Status")] Phone phone)
        {
            if (id != phone.Id)
            {
                return NotFound();
